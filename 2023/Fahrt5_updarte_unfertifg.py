...
# Fahrt ist zuständig für:
# Part 1 - Öltanker abholen
# Part 2 - Individuelles Bauwerk sowie Energieeinheiten in die Mitte bringen, Energieeinheit beim Energiespiecher abliefern, Öltanker abliefern
...
# Collect OIL VEHICLE
current_yaw = yaw(1)
drive.move(10, "cm", default_speed)
current_yaw = yaw(90)
drive.move(10, "cm", default_speed)
current_yaw = yaw(0)
drive.set_default_speed(default_speed)
drive.move(15, "cm", default_speed)
